...
-(void) changeSelectedUnit:(NSPopUpButton *)sender {
    selectedUnit = (SWUnit)sender.selectedTag;
    
    [widthUnits selectItemAtIndex:selectedUnit];
    [heightUnits selectItemAtIndex:selectedUnit];
}
